...
/*   Updated: 2019/03/01 09:48:10 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_conv_d_ptr(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_ptrd(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_ptrdh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_ptrdhh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_ptrdl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_ptrdll(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptroll(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptrol(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptrohh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptroh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptro(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_ptr(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_ptr(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_ptrfl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_ptrfbigl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_e_ptr(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_e_ptrel(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_e_ptrebigl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_g_ptr(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_g_ptrgl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_g_ptrgbigl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_c_ptrc(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_s_ptrs(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_p_ptrp(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_mat(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_matd(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_matdh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_matdhh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_matdl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_d_matdll(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_mat(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_mato(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_matoh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_matohh(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_matol(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_o_matoll(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_mat(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_matfl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_f_matfbigl(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_c_matc(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_s_mats(t_format *format, va_list ap,
						t_liststr **list);
int					ft_conv_p_matp(t_format *format, va_list ap,
						t_liststr **list);
...
int					ft_conv_big_e(t_format *format, va_list ap,
						t_liststr **list);
